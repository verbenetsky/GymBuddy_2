package com.example.gymbuddy.ui.search
...
import com.example.gymbuddy.ui.search.UserSearchViewModel.UserSearchState
...
fun SearchScreen(
    ...
    val currentUserInformation by userManagementViewModel.userInformationState.collectAsState() // info about current user
