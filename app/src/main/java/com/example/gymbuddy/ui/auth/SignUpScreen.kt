        ...
        Column(
            ...
            if (!validation.isPasswordValid && password.isNotEmpty()) {
                ...
                Text(
                    ...
                    color = if (authViewModel.analyzePasswordRequirementsLength(password)) MaterialTheme.colorScheme.onSurface else MaterialTheme.colorScheme.error,
                    style = MaterialTheme.typography.labelSmall,
                )
                Text(
                    text = stringResource(R.string.password_one_digit),
                    color = if (authViewModel.analyzePasswordRequirementsOneDigit(password)) MaterialTheme.colorScheme.onSurface else MaterialTheme.colorScheme.error,
                    style = MaterialTheme.typography.labelSmall,
                )
            }
                ...
                onClick = {
                    ...
                    authViewModel.signUp(
                        ...
                        onSuccess = {
                            ...
                            authViewModel.setUserData(userData.email, Firebase.auth.currentUser!!.uid)
                            authViewModel.resetPassword()
                        },
                        onError = { msg ->
